...
export default function Hero() {
  ...
  const handlePrimaryAction = () => {
    router.push('/'); // Navigate to consultation booking
  };
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Transform your operations with seamless SAP integration. We connect your systems,
              optimize workflows, and deliver measurable ROI in 90 days or less.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              >
                <Play className="mr-2 size-5" /> View Case Study
              </Button>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="SAP ERP dashboard interface showing real-time business analytics"
                  fill
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">90</span> days avg
              </p>
            </div>
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">340%</span> average
              </p>
            </div>
          </div>
        </div>
