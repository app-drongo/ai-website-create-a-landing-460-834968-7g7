  ...
  const offices = [
    {
      ...
      address: '2500 Enterprise Blvd, Suite 400, Atlanta, GA',
      timezone: 'EST (UTC-5)',
    },
    {
      city: 'SAP EMEA Center',
      address: 'Walldorf Technology Park, Building 7, Germany',
      timezone: 'CET (UTC+1)',
    },
    {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="We need to integrate SAP S/4HANA with our existing CRM and e-commerce platforms. Currently running SAP ECC 6.0 with 500+ users across 3 locations..."
                  />
                </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-primary/10 rounded-lg">
                  <p className="text-sm text-primary font-medium flex items-center gap-2">
                    ...
                    24/7 critical system support for S/4HANA Enterprise clients
                  </p>
                </div>
              </CardContent>
            </Card>
